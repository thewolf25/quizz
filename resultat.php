...
<main class="main">
      ...
      <p align="center"><b>Resultat pour le Quiz n°: <?php echo $index_quiz; ?></b></p>
    	...
    	<fieldset style="font-size:14px;padding:16px;line-height:1.8;width: 80%; margin:  0px auto;border:2px solid #666;
            ...
            <tr>
            	<th>Nom</th><th>Prenom</th><th>N° Tel</th><th align="center">Mail</th><th>Totale Note </th><th>Totale Temps</th><th>Totale Rep V</th><th> Détails</th>
            </tr>
            
            <?php
				
				$sql_resultat="SELECT index_medecin,SUM(temp_rep),SUM(note),SUM(rep_val) FROM reponse where index_quiz='".$index_quiz."' group by index_medecin";
